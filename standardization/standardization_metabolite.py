...
# 1. 读取要保留的Bacteria名称
with open("/user_data/yezy/zhangjm/FE_kg/Merge/feature_vector/metabolite_names0725.txt", "r", encoding="utf-8") as f:
...
# 4. 保存
df_filtered.to_csv("final_use0725.tsv", sep="\t", index=False)
print("✅ 已保存筛选后的五元组文件：final_use0725.tsv")